...
const Testimonials = () => {
  return (
    <div className="mt-20 tracking-wide">
      <h2 className="my-10 text-3xl text-center sm:text-5xl lg:text-5xl lg:my-20">What People are saying</h2>
      <div className="flex flex-wrap justify-center">
        {testimonials.map((testimonial , index)=>(
            <div key={index} className="w-full px-4 py-2 sm:w-1/2 lg:w-1/3">
                <div className="p-6 font-thin border rounded-md bg-neutral text-md border-neutral-600">
